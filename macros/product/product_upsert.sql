{% materialization product_upsert, adapter='snowflake' %}
    ...
    {% set merge_sql %}
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            DBT_INTERNAL_SOURCE.PDT_ID,
            DBT_INTERNAL_SOURCE.SUB_CTGRY_KY,
            DBT_INTERNAL_SOURCE.CTGRY_KY,
            DBT_INTERNAL_SOURCE.PDT_DESC,
            DBT_INTERNAL_SOURCE.ACTV_FLG,
            DBT_INTERNAL_SOURCE.PRICE,
