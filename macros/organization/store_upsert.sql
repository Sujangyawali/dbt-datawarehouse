{% materialization store_upsert, adapter='snowflake' %}
    ...
    {% set merge_sql %}
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            DBT_INTERNAL_SOURCE.LOCN_ID,
            DBT_INTERNAL_SOURCE.RGN_KY,
            DBT_INTERNAL_SOURCE.CNTRY_KY,
            DBT_INTERNAL_SOURCE.LOCN_DESC,
            DBT_INTERNAL_SOURCE.LAST_OPEN_TMS,
            DBT_INTERNAL_SOURCE.ACTV_FLG,
