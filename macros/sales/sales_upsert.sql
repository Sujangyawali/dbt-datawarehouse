{% materialization sales_upsert, adapter='snowflake' %}
    ...
    {% set merge_sql %}
        ...
        WHEN NOT MATCHED THEN INSERT (
            ...
            DBT_INTERNAL_SOURCE.SLS_ID,
            DBT_INTERNAL_SOURCE.LOCN_KY,
            DBT_INTERNAL_SOURCE.DT_KY,
            DBT_INTERNAL_SOURCE.PDT_KY,
            DBT_INTERNAL_SOURCE.CUSTOMER_KY,
            DBT_INTERNAL_SOURCE.TRANSACTION_TIME,
            DBT_INTERNAL_SOURCE.QTY,
            DBT_INTERNAL_SOURCE.AMT,
            DBT_INTERNAL_SOURCE.DSCNT,
